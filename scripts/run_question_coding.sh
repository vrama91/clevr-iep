...
ROOT_DIR="/coc/scratch/rvedantam3/runs/pytorch_discovery/question_coding_num_workers_1_load_train"
...
if [ $DEBUG -eq "1" ]; then
  ...
  for supervision in 100 500 5000 10000 699989
  #for supervision in  500 
  do
    JOB_STRING="$VERSION"_"${supervision}"_mix_"$MIXING_FACTOR"_ssl_"${SSL_ALPHA}"
    RUN_TRAIN_DIR=${ROOT_DIR}/${JOB_STRING}
    TRAINVAL_STRING="question_coding"
